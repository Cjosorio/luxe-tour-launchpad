...
export const WhatsAppFloat = () => {
  ...
  return (
    ...
    >
      ...
      <span className="relative flex items-center justify-center h-14 w-14 rounded-full bg-gradient-gold shadow-gold transition-transform group-hover:scale-110">
        <svg viewBox="0 0 24 24" className="h-7 w-7 fill-primary-foreground" aria-hidden>
