...
export const WhatsAppFloat = () => {
  ...
  return (
    ...
    >
      ...
      <span className="relative flex items-center justify-center h-14 w-14 rounded-full bg-foreground text-background shadow-elegant transition-all group-hover:bg-primary group-hover:text-primary-foreground group-hover:scale-110">
