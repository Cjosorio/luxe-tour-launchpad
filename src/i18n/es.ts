export const es = {
  ...
  cta: {
    ...
    reserve: "Reserva tu transporte",
    viewDetails: "Ver detalles",
    quoteThis: "Cotizar este vehículo",
  ...
  contact: {
    ...
    title: "Tu próximo viaje, perfectamente coordinado.",
    subtitle:
      "Cuéntanos los detalles y armamos una cotización a tu medida en minutos.",
